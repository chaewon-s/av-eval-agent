...
from opencda.core.plan.behavior_agent_s1 \
    import BehaviorAgent1
...
class VehicleManager(object):
    ...
    def __init__(
        ...
        datadump_config = config_yaml['datadump']
        ...
        if 'platooning' in application:
            ...
            self.agent = PlatooningBehaviorAgent(
                ...
                platoon_config,
                carla_map)
        elif "scenario1" in datadump_config['title']:
            self.agent = BehaviorAgent1(vehicle, carla_map, behavior_config)
        else:
        ...
        if data_dumping:
            self.data_dumper = DataDumper(self.perception_manager,
                                          ...
                                          scenario_title=datadump_config['title'])
        else:
