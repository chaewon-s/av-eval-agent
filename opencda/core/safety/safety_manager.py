...
class SafetyManager:
    ...
    def __init__(self, vehicle, params):
        ...
        traffic_light_params = params.get('traffic_light_detector', {})
        if traffic_light_params.get('enabled', True):
            self.sensors.append(TrafficLightDector(traffic_light_params,
                                                   vehicle))
